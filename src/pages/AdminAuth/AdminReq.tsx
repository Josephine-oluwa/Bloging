...
const onSubmit = handleSubmit(async (data) => {
  ...
  return (
    <div className='w-full h-[100vh] bg-slate-100 flex justify-center flex-col items-center'>
...
<img  className='w-[150px] h-[170px]  object-cover mt-[20px] border-1 border-black' src={Avatar}/> 
